...
- Help students understand how they work through visualization (like with a whiteboard).
...
You can also test the web application online by clicking [here](https://fchavonet.github.io/web-doubly_linked_list_visualizer/). 
